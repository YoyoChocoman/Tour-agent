...
主要包含天氣查詢與旅遊景點推薦功能，並針對 LLM 的 Prompt 進行了優化，以確保輸出的格式與內容最符合用戶需求。
...
### 2. 客製化旅遊推薦 (Tourism Tool)
- **功能**：查詢特定城市的旅遊景點。
- **特點**：具備智慧過濾邏輯。系統不會列出所有景點，而是根據用戶的興趣偏好（如：歷史、購物、自然風光）從資料庫中篩選最合適的景點，並解釋推薦原因。
- **工具名稱**：`get_tourism`
